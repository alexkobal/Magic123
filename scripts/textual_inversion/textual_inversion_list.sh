...
# bash scripts/textual_inversion/textual_inversion.sh 0 runwayml/stable-diffusion-v1-5 /data/sandor/images/monopointcloud/multiview/textual_inversion /data/sandor/images/monopointcloud/multiview/statue_token _statue_ statue --max_train_steps 3000